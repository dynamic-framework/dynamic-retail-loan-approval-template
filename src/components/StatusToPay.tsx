...
export default function StatusToPay() {
  ...
  return (
    <div className="row justify-content-center">
      <div className="col-12 col-lg-8 col-xl-6 d-flex flex-column gap-6 justify-content-center align-items-center">
        ...
        <div className="d-flex align-items-center gap-4 bg-light rounded-2 py-3 px-4 shadow-sm">
